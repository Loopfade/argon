...
| GitHub Actions | Сторонние Actions закреплены commit SHA; APK собирается тремя последовательными jobs с общим ограниченным `ccache`, чтобы каждая часть укладывалась в шестичасовой лимит hosted runner |

...
| GitHub Actions: закреплённые входные данные, 6 Python-тестов, сборка C++ helper и 32 проверки BoringSSL | [Успешно, запуск №2](https://github.com/su8d/argon/actions/runs/35429972730), commit `f919a2a17cec9cc11d7e1a9819216acbebfbd553` |
...
| Полная сборка APK в GitHub Actions | [Запуск №1](https://github.com/su8d/argon/actions/runs/35430044143) остановился до компиляции на hook патчей подпроектов Vanadium; preflight, базовые патчи и синхронизация зависимостей пройдены, после очистки runner было 108 GiB свободно |
...
| Второй запуск полной сборки | [Запуск №2](https://github.com/su8d/argon/actions/runs/35430962395) успешно применил все патчи подпроектов, загрузил закреплённое расширение, применил патч УЦ и прошёл C++-тест политики. Остановился перед GN: отсутствовал `python3_bin_reldir.txt` в depot_tools |
...
сборки и артефакты доступны в [GitHub Actions](https://github.com/su8d/argon/actions/workflows/build.yml).
